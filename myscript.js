    //THESE ARE MY NOTES!!!!!!!!!!!!!!!!
        //very simple, just replace the "#squaremakerinput value with the value of five so that the computer knows what to reference. I tried to make the var x= x but it started an infinite loop and made my entire javascript crash, but I have since learned from my foolish mistakes. OTHERWISE, I used code from the previous JavaScript, such as the the swapMe
